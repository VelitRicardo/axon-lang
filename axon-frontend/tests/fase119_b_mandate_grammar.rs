//! §Fase 119.b — the `mandate` control law survives the parser.
//!
...
//!
//! This is the §111 defect — an advertised primitive whose cable is cut — living
//! in the parser rather than the runtime, which is why §111's own audit did not
