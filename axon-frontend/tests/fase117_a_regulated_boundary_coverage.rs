//! §Fase 117.a — `axon-T957` **RegulatedBoundaryCoverage**: the ESK Fase 6.1
...
//! failure is a **type error**, not a lint warning."* It was not. §111 F16
...
//! not weak. The same shape `lease` had before §113 gave it a subject.
//!
...
//!    a label is not a control. This is the §111 presence check staying dead.
...
//! 8. The law is NOT suppressed by the §39.e `axon-E039` wire gate — an
...
#[test]
fn fase117a_covered_regulated_endpoint_is_clean() {
...
#[test]
fn fase117a_missing_shield_is_a_type_error() {
...
#[test]
fn fase117a_partial_shield_names_exactly_the_missing_classes() {
...
#[test]
fn fase117a_endpoint_compliance_label_does_not_cover() {
    // Property 4 — the §111 F16 presence check stays dead. The endpoint
...
#[test]
fn fase117a_kappa_survives_envelope_list_and_stream_wrapping() {
...
#[test]
fn fase117a_body_side_of_the_boundary_counts() {
...
#[test]
fn fase117a_unregulated_endpoint_is_untouched() {
...
#[test]
fn fase117a_fires_independently_of_the_e039_wire_gate() {
    // Property 8 — the §39.e gate suppresses the CARDINALITY gate, never
