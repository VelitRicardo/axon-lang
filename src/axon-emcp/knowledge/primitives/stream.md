---
name: stream
summary: "Algebraic-effects stream block — the body is parsed, lowered and EXECUTED over the Free-Monad CPS handler runtime (v2.67.0; it used to be discarded at parse time)."
category: operators
top_level: false
since: "pre-v2.67.0; body executed since v2.67.0"
grammar: |
  stream {
      <handler-steps>
  }
