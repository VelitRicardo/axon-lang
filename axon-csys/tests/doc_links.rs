...
//!
//! The third and last crate. v2.83.0 ratcheted `axon-lang` and measured this one
//! at 6 broken intra-doc links without gating it; v2.83.0 closes the CLASS
...
/// v2.83.0's measurement of the same crate on 2026-08-08.
///
...
fn rustdoc_stderr() -> String {
    ...
    let out = Command::new(cargo)
        ...
        // v2.89.0 — do NOT inherit the parent's build flags.
        //
...
#[test]
fn csys_broken_intra_doc_links_only_ever_shrink() {
