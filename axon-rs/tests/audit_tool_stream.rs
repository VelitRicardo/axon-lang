//! v1.29.0 — Audit-row extension end-to-end tests.
//!
...
//! and lets a future cycle diverge the two (raw chunks pre-
...
// ════════════════════════════════════════════════════════════════════
// section 1 — Disjunct (b) tool-stream rows populate all 4 fields × 5
// ════════════════════════════════════════════════════════════════════
...
async fn s1_disjunct_b_audit_row_carries_tool_output_hash_hex_matching_output_hash() {
    ...
    // Future cycles may diverge them (raw pre-degrader vs post-policy wire).
    assert_eq!(
...
// ════════════════════════════════════════════════════════════════════
// section 2 — Disjunct (d) Yield + legacy bridge populate 3 of 4 fields × 3
// ════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════
// section 3 — D4 byte-compat: None fields elided + populated fields surface × 4
// ════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════
// section 4 — Replay endpoint surfaces extended fields + composition × 2
// ════════════════════════════════════════════════════════════════════
