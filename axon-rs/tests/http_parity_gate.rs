...
//! v1.24.0 parity gate — grep-style invariants enforcing the
...
// ────────────────────────────────────────────────────────────────────
// section 1 — Retired flow_plan / axon_server / runtime_* symbols
// ────────────────────────────────────────────────────────────────────
...
fn no_run_streaming_async_path_references() {
    ...
    assert_no_hits(
        ...
        "The `axon_server::run_streaming_async_path` v1.25.0 canonical \
         Step hot path was retired in 33.z.e. The dispatcher (v1.24.0 \
...
// ────────────────────────────────────────────────────────────────────
// section 2 — Closed-catalog size pin
// ────────────────────────────────────────────────────────────────────
