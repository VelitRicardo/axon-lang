//! v1.24.0 integration tests — algebraic-effect handler nodes.
//!
...
/// v2.83.0 — a declared mandate for fixtures that route MandateApply
/// through the real enforcement path.
/// v2.83.0 — a declared ots + deterministic transformer for fixtures
...
// ────────────────────────────────────────────────────────────────────
// section 1 — Public apply_* helpers (OSS identity)
// ────────────────────────────────────────────────────────────────────
...
// v2.83.0 — `apply_ots_oss_passthrough` was DELETED here. It pinned the
// v2.67.0 F18 identity (a µ-law codec transforming nothing, in green). The
...
// v2.83.0 — `apply_mandate_oss_passthrough` was DELETED here. It pinned
// the v2.67.0 F18 identity ("gdpr_erasure" transforming nothing, in green, for
...
// ────────────────────────────────────────────────────────────────────
// section 2 — ShieldApply through dispatch_node
// ────────────────────────────────────────────────────────────────────
...
// ────────────────────────────────────────────────────────────────────
// section 3 — OtsApply through dispatch_node
// ────────────────────────────────────────────────────────────────────

/// v2.83.0 — this routing test used to ride the identity passthrough.
...
// ────────────────────────────────────────────────────────────────────
// section 4 — MandateApply through dispatch_node
// ────────────────────────────────────────────────────────────────────

/// v2.83.0 — this routing test used to pass through the identity
...
// ────────────────────────────────────────────────────────────────────
// section 5 — ComputeApply through dispatch_node
// ────────────────────────────────────────────────────────────────────


/// v2.67.0 — a real declared compute: `Sum(a, b) = a + b`.
///
/// Before v2.67.0, none of the tests below needed one: `run_compute_apply` bound the
...
async fn dispatch_node_routes_compute_apply() {
    ...
    // `"compute:sum(100, 200)"` — the lie, pinned green (v2.67.0 F10).
...
// ────────────────────────────────────────────────────────────────────
// section 6 — Listen through dispatch_node
// ────────────────────────────────────────────────────────────────────
...
// ────────────────────────────────────────────────────────────────────
// section 7 — DaemonStep through dispatch_node
// ────────────────────────────────────────────────────────────────────
...
// ────────────────────────────────────────────────────────────────────
// section 9 — Composition with cognitive + orchestration
// ────────────────────────────────────────────────────────────────────
...
// ────────────────────────────────────────────────────────────────────
// v1.4.0 — Step counter discipline
// ────────────────────────────────────────────────────────────────────
...
async fn algebraic_handlers_advance_step_counter() {
    ...
    // v2.83.0 — the ots must resolve now; register a transformer for it.
    ...
    // v2.83.0 — the mandate must resolve now; "t" satisfies its clause.
    ctx.mandate_specs = std::sync::Arc::new(vec![test_mandate_spec(
        "s",
        "must contain \"t\"",
    )]);
