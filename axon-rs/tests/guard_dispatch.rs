//! v2.88.0 — **the confidence guard RUNS: bounded, monotone,
...
// ── section 1 — MONOTONE: a degrading refinement is never adopted ─────────────────
...
// ── section 2 — EARLY EXIT: a cleared floor spends nothing ─────────────────────────
...
// ── section 3 — the recovery is OBSERVABLE on the wire ─────────────────────────────
...
// ── section 4 — a validation WITHOUT a guard loops zero times ─────────────────────
