...
//! v1.31.0 (D5) — no silent stub, honest failure.
//!
...
// ─── section 1 — JSON honest failure is a structured 503 ──────────────────
...
// ─── section 2 — SSE honest failure is a dialect-correct error event ──────
...
// ─── section 3 — end-to-end honest 503 for an unresolvable route ──────────
...
// ─── section 4 — explicit `backend: stub` never hits honest failure (D5) ──
