...
//! v1.21.0 — Server-Sent Events wire-format conformance fuzz.
//!
...
//! format invariant set (plan vivo section 4):
//!
...
//!
//! Seeds 0..100 mirror v1.20.0's D12 fuzz cadence so CI reporters
...
/// `Xorshift` in the v1.20.0 D12 fuzz pack.
#[derive(Clone, Copy)]
struct Xorshift(u64);
...
/// W3C SSE wire-format invariant assertions per plan vivo section 4.
