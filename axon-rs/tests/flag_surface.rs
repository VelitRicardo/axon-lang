...
//! v1.22.0 — CLI flag + env var opt-in surfaces for
...
// ─── section 1 — Truthy env var parser, accept matrix ───────────────────────
...
// ─── section 2 — ServerConfig construction precedence ──────────────────────
...
// ─── section 3 — Precedence rule (CLI > env > default) ─────────────────────
...
// ─── section 4 — Cross-stack contract anchors ──────────────────────────────
