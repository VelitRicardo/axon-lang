...
//! v1.31.0 (D8) — resolution observability.
//!
...
// ─── section 1 — inject_backend_resolution (pure) ─────────────────────────
...
// ─── section 2 — JSON response: header + body backend_resolution ──────────
...
// ─── section 3 — server-default route: reason is `server_default` ─────────
...
// ─── section 4 — SSE response carries the X-Axon-Backend header ───────────
...
// ─── section 5 — honest failure reports `no_backend_available` ────────────
