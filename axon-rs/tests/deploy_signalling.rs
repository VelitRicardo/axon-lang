...
//! v1.31.0 (D10, D11) — deploy-time signalling + `steps_executed`
//! honesty.
//!
...
// ─── section 1 — a resolvable route deploys with no warnings ──────────────
...
// ─── section 2 — an unresolvable route deploys with a deploy warning ──────
...
// ─── section 3 — D11: a stub-backed route runs a REAL step ────────────────
...
// ─── section 4 — D11: honest failure, never a hollow steps:0 body ─────────
