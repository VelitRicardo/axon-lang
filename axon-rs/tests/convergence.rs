//! v1.29.0 — 4-disjunction convergence end-to-end tests.
//!
...
//! at chunk granularity via `StreamPolicyEnforcer` (v1.24.0).
...
// ════════════════════════════════════════════════════════════════════
// section 1 — unified_stream_handler direct surface × 5
// ════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════
// section 2 — Real BackpressurePolicy enforcement × 4
// ════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════
// section 3 — Convergence: byte-equal wire shape across disjuncts × 4
// ════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════
// section 4 — Cancel discipline through unified handler × 3
// ════════════════════════════════════════════════════════════════════
...
async fn s4_mid_stream_cancel_observed_via_summary_when_chunks_already_emitted() {
    ...
    // cancellation see e_2 section 3 cancel_mid_stream_*.)
    let cancel = CancellationFlag::new();
...
// ════════════════════════════════════════════════════════════════════
// section 5 — Audit row populated with real counters × 3
// ════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════
// section 6 — Composition + back-compat × 3
// ════════════════════════════════════════════════════════════════════
