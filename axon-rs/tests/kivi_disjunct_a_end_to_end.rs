...
//! v1.23.0 — End-to-end "last cable" test for adopter `MIGRATION_TO_AXON.md`.
//!
...
async fn kivi_disjunct_a_strict_mode_returns_sse() {
    // Strict mode flips v1.22.0 D1 on: `produces_stream` true →
...
async fn kivi_disjunct_a_legacy_no_accept_stays_json_d9() {
    ...
    // The v1.22.0 diagnostic header MUST fire — adopter sees the
