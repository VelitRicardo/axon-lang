...
//! v1.29.0 — End-to-end MCP tool streaming tests.
//!
//! [`axon::emcp::McpStreamingTool`] is the second non-stub provider
//! with first-class streaming surface (after v1.29.0's
...
//! 6. End-to-end composition with the dispatcher arm (v1.29.0):
...
// ────────────────────────────────────────────────────────────────────
//  Test-server scaffolding (same pattern as http_streaming.rs)
// ────────────────────────────────────────────────────────────────────
...
// ════════════════════════════════════════════════════════════════════
// section 2 — JSON-RPC error surfaces × 3
// ════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════
// section 4 — Cancel propagation × 2
// ════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════
// section 5 — End-to-end composition with dispatcher arm × 2
// ════════════════════════════════════════════════════════════════════
