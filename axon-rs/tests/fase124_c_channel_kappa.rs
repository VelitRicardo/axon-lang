//! §Fase 124.c — **κ-coverage at the channel egress seam, from source.**
//!
//! # What this is the proof of
//!
//! The `compliance` ledger row's gap named this seam precisely: the typed
//! bus HAD a compliance predicate (`ShieldComplianceFn`, §13-era), and the
...
//!
//! §124.c closes both doors of the rule, and this gate exercises both FROM
//! THE SAME SOURCE FILES on disk — §119.n: a gate is proof of a PATH only
...
/// for: hand-assembled or pre-§124 IR that never met `axon-T1215`.
...
/// from the IR it registers channels from. Before §124.c this publish
