//! v2.83.0 — **the published documentation links somewhere**.
//!
...
//! that exists, is red, and is watched by nobody (v2.67.0's dead cable, v2.81.0's
//! gate that stayed red for a commit, v2.81.0's port gate that measured itself).
...
//! only be revised DOWNWARD. It is the same mechanism v2.81.0 used for
//! `KNOWN_DEBT`, which v2.83.0 drove to zero — the shape is known to work here.
//!
//! # What this costs
//!
...
/// in 33.z.e — v2.83.0 corrected eleven doc sites that named it and its
...
#[test]
fn broken_intra_doc_links_only_ever_shrink() {
