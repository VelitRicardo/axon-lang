...
//! v2.3.0 — End-to-end test of the session-typed WebSocket runtime.
//!
...
//! triggers the v2.3.0 "no rule at n=0" axiom at runtime
//!    (`credit_exhausted`).
...
{
    // v2.81.0 — tungstenite 0.26+ carries text payloads as `Utf8Bytes`.
...
// ─── 4. Credit exhaustion — runtime witness of the v2.3.0 n=0 axiom ────────
